...
# def test_register_customer(client):
    ...
    # # password not 8 chars
    # res = client.get('/register/customer/george/p/georgepp/1234567/1234567/4444444444444444')
    # data = json.loads(res.data.decode('utf-8'))
    # assert data == {'success': 'false', 'error_msg': 'password must have at least 8 characters'}
    # assert res.status_code == 400

    # # password does not match confirm password
    # res = client.get('/register/customer/george/p/georgepp/12345678/1234567/4444444444444444')
    # data = json.loads(res.data.decode('utf-8'))
    # assert data == {'success': 'false', 'error_msg': 'password and confirm password should match'}
    # assert res.status_code == 400
    ...
    # data = json.loads(res.data.decode('utf-8'))
    # assert data == {'success': 'false', 'error_msg': 'credit card num alredy exists in database'}
    # assert res.status_code == 400
    ...
    # data = json.loads(res.data.decode('utf-8'))
    # assert data == {'success': 'false', 'error_msg': 'creditcard must have 16 digits'}
    # assert res.status_code == 400
